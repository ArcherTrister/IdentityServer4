...
namespace IdentityServer4.Extensions
{
    ...
    {
        /// <summary>
        /// Creates the default JWT header dictionary
        /// </summary>
        ...
        /// <returns></returns>
        public static async Task<Dictionary<string, object>> CreateJwtHeaderDictionary(this Token token,
            IdentityServerOptions options, IKeyMaterialService keys, ISystemClock clock, ILogger logger)
        {
            ...
            if (credential.Key is X509SecurityKey x509Key)
            {
                ...
                additionalHeaderElements.Add("x5t", Base64Url.Encode(cert.GetCertHash()));
            }
        ...
        private static object AddObject(Claim claim)
        {
            ...
            if (claim.ValueType.Equals(IdentityServerConstants.ClaimValueTypes.Json,
